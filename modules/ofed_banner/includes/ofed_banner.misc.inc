 ...
 * @return array 
 */
function _ofed_banner_list_options_menu() {
  $menus = menu_get_menus(FALSE);
  unset($menus['menu-cms-menu']);
  unset($menus['devel']);
...
/**
 * Options callback for ofed_banner_menu field
 * @return - returns an indexed array as integer => string
 */
function _ofed_banner_options_list() {
  $menu_list = _ofed_banner_list_options_menu();
