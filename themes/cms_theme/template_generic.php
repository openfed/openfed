 ...
 * @param numeric $length Length to render
 * @param string $more_link Can be a path for the more link
 * @return string
 */
...
function cms_theme_checkbox($variables) {
  ...
  _form_set_class($element, array('form-checkbox', cms_theme_getThemeableFormCheckboxClass()));
...
function cms_theme_file($variables) {
  ...
  _form_set_class($element, array('form-file', cms_theme_getThemeableFormFileClass()));
...
function cms_theme_password($variables) {
  ...
  _form_set_class($element, array('form-text', cms_theme_getThemeableFormPasswordClass()));
...
function cms_theme_textfield($variables) {
  ...
  _form_set_class($element, array('form-text', cms_theme_getThemeableFormTextClass()));
